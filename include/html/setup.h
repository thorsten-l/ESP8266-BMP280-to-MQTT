...
const char SETUP_HTML_TEMPLATE[] PROGMEM =
  ...
  "<div class='panel'>\n"
  "<fieldset>\n"  
  "<div class='accordion'>BME280 Sensor</div>\n"
  "<div class='panel sub-panel'>\n"
    "<div class=\"pure-control-group\"><label for=\"seid0\">I2C-Address</label><input id=\"seid0\" type=\"text\" name=\"i2c_sensor_address\" maxlength=\"64\" value=\"%i2c_sensor_address%\"></div>\n"
  "</div>\n"
  "</fieldset></div>\n"
  ...
  "<div class='panel sub-panel'>\n"
    ...
    "<div class=\"pure-control-group\"><label for=\"pgid29\">Topic JSON</label><input id=\"pgid29\" type=\"text\" name=\"mqtt_topic_json\" maxlength=\"64\" value=\"%mqtt_topic_json%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"mgid29\">Sending Interval (s)</label><input id=\"mgid29\" type=\"text\" name=\"mqtt_sending_interval\" maxlength=\"64\" value=\"%mqtt_sending_interval%\"></div>\n"
  "</div>\n"
